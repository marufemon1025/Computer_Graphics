...
rot_points = [(x * math.cos(rad) - y * math.sin(rad),
               x * math.sin(rad) + y * math.cos(rad)) for x, y in points]
...
plot_polygon(trans_points, 'red', 'Translated')
plot_polygon(rot_points, 'green', 'Rotated')
plt.legend()
